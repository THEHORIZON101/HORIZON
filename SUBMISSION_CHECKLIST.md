# ReverieHacks Software Development Submission Checklist
...
- [ ] Public access works while signed out.
- [ ] Live demo and README links work.
- [ ] No API key, token, or `.env.local` is committed.
- [ ] `npm ci` succeeds.
- [ ] `npm test` passes.
...
- [ ] The 5,000 validation checks are mentioned.
- [ ] No unrelated tabs or private information are visible.
